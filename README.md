...
- `portfolio/heewung-song-portfolio-v3.html`: 4개 챕터·22장으로 구조를 재설계한 현재 대표 종합 포트폴리오. 각 챕터가 `① 무엇인가 → ② 기능별 실패 사례·의도적 경계 → ③ 결과와 한계`의 동일한 3단 리듬을 따르며, 병원 전화 Voice AI(인/아웃바운드 통합)·통화 관측과 평가·챗봇 고객상담·AIU 사내 업무지원 순으로 전개된다
