...
- `resume/product-engineer.md`: 현재 기준으로 가장 정제된 제품 엔지니어 이력서
- `portfolio/outbound-voice-agent.md`: 현재 메인 포트폴리오 케이스 스터디
- `assets/heewung-song-infographic.png`: 이력서와 함께 쓰는 시각 자료 자산

## 저장소 구성

- `docs/source/origin-resume.md`: 사실 기준의 원본 이력서 소스
...
2. `docs/source/origin-resume.md`로 사실 기반 경력 재료를 확인합니다.
3. `docs/guides/resume-guide.md`로 작성 원칙을 확인합니다.
4. `resume/product-engineer.md`에서 현재 이력서 결과물을 봅니다.
5. `portfolio/outbound-voice-agent.md`에서 대표 포트폴리오 문서를 읽습니다.
